...
export const BtnList = [
  ...
  { label: "Experience", link: "#work", icon: "experience", newTab: false },
  { label: "Contact", link: "#contact", icon: "contact", newTab: false },
  {
    label: "Github",
    link: "https://github.com/shareef-mohammed",
    icon: "github",
    newTab: true,
  },
  {
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/mohammed-shareef-2b38a422a",
    icon: "linkedin",
    newTab: true,
  },
  {
    label: "Resume",
    link: "./Mohammed Shareef A - Full Stack Developer (Resume).pdf",
    icon: "resume",
    newTab: true,
  },
];
